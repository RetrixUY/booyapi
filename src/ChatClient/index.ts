...
import { ChatMessage, ModAction, MsgType, ModActionType, SendMsgType, BadgeCode } from "../types/chat";
import { GiftReceived, GiftStatus } from "../types/gift";
             ...
             messages.forEach(async (message: any) => {
                 switch (message.event) {
                     ...
                     case MsgType.SEND_GIFT:
                         this.emit('giftReceived',processGift(message,this.channelId.toString()))
                 }
             });
         }
     }
 ...
 function processGift(message: socketGiftReceived, channelId: string): GiftReceived {
