...
export default {
  getSummaryList(sessionKey: string): Promise<Rankings> {
    return v3('get', 'rankings', { count: 6 },sessionKey);
  },
  get(
    key: RankingListKey,
  ...
  getWatchedTimes(
    ...
    return v3('get', 'rankings/watched-times', {
      by,
      exclSignedStreamer
    },sessionKey);
  },
  getPopularity(
    ...
    return v3('get', 'rankings/popularity', {
      by,
      exclSignedStreamer
    },sessionKey);
  },
  getContributions(
    ...
    return v3('get', 'rankings/contributions', { by },sessionKey);
  }
};
