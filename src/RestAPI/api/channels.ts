...
export default {
  alertConfigs: {
    ...
    patch(
      ...
      return v3(
        'patch',
        `channels/${channelId}/alert-configs`,
        {
          ...config,
        },
        sessionKey
    ...
    getTab(
      ...
      return v3(
        'get',
        `channels/${channelId}/alert-configs/${tab}`,
        {},
        sessionKey
      );
    },
    postTest(
      ...
      return v3(
        'post',
        `channels/${channelId}/alert-config-test/${tab}`,
        {},
        sessionKey
      );
    },
  ...
  ffLuckyDraws: {
    ...
    getLogs(
      ...
      return v3(
        'get',
        `channels/${channelId}/ff-lucky-draws/logs`,
        {
          cursor,
          count,
        },
    ...
    getRoundHistory(
      ...
      return v3(
        'get',
        `channels/${channelId}/ff-lucky-draw-rounds`,
        {
          cursor,
          count,
        },
    ...
    getRound(
      ...
      return v3(
        'get',
        `channels/${channelId}/ff-lucky-draw-ongoing-round`,
        {},
        sessionKey
      );
    },
    deleteRound(
      ...
      return v3(
        'delete',
        `channels/${channelId}/ff-lucky-draw-rounds/${roundId}`,
        {},
        sessionKey
      );
    },
  ...
  firebaseTokens: {
    post(channelId: number, sessionKey: string): Promise<{token: string}> {
      return v3(
        'post',
        `channels/${channelId}/firebase-tokens`,
        {},
        sessionKey
      );
    },
  ...
  gifts: {
    ...
    getTopGifters(
      ...
      return v3(
        'get',
        `channels/${channelId}/gifts/top-gifters`,
        {
          type,
        },
        sessionKey
  ...
  streamKeys: {
    post(
      channelId: number,
      sessionKey: string
    ): Promise<{streamKey: string; url: string}> {
  ...
  streamSettings: {
    get(channelId: number, sessionKey: string): Promise<StreamSettings> {
      return v3(
        'get',
        `channels/${channelId}/stream-settings`,
        {},
        sessionKey
      ).then((res: StreamSettings) => {
        if (!res.resolution) {
          res.resolution = '720p';
        }
        return res;
  ...
  savedHostees: {
    get(
      ...
      return v3(
        'get',
        `channels/${channelId}/saved-hostees`,
        params,
        sessionKey
      );
    },
    ...
    delete(
      ...
      return v3(
        'delete',
        `channels/${channelId}/saved-hostees/${hosteeId}`,
        {},
        sessionKey
      );
    },
  ...
  socialLinks: {
    post(
      ...
      return v3(
        'post',
        `channels/${channelId}/social-links`,
        {
          platform,
          link,
        },
  ...
  streamerPrograms: {
    get(
      channelId: number,
      recordOffset: StreamerProgramRecordOffset = StreamerProgramRecordOffset.CURRENT_MONTH,
      sessionKey: string
    ): Promise<StreamerProgramStats> {
      return v3(
        'get',
        `channels/${channelId}/streamer-programs`,
        {
          recordOffset,
        },
        sessionKey
    ...
    payouts: {
      get(
        ...
        return v3(
          'get',
          `channels/${channelId}/streamer-programs/payouts`,
          {},
          sessionKey
        );
      },
      post(
        channelId: number,
        recordId: number,
        withdrawType: StreamerProgramWithdrawType,
        sessionKey: string
      ) {
        return v3(
          'post',
    ...
    getPermissions(
      channelId: number,
      sessionKey: string
    ): Promise<StreamerEntryLevel> {
      return v3(
        'get',
        `channels/${channelId}/streamer-programs/permissions`,
        {},
        sessionKey
      );
    },
  ...
  pinnedPlaybacks: {
    get(
      ...
      return v3(
        'get',
        `channels/${channelId}/pinned-playbacks`,
        {
          type,
          gameId,
          contentLanguage,
