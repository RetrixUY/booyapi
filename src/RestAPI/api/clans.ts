...
export default {
  ...
  members: {
    ...
    delete(clanId: number, memberId: number,sessionKey:string) {
      return v3('delete', `clans/${clanId}/members/${memberId}`,{},sessionKey);
    },
    stats: {
      get(
        clanId: number,
  ...
  playbacks: {
    ...
    count: {
      get(
        ...
        return v3('get', `clans/${clanId}/playbacks/count`, {
          type
        },sessionKey);
      }
    }
  ...
  applications: {
    ...
    reviews: {
      post(clanId: number, appId: number, review: ClanApplicationReview,sessionKey:string) {
        return v3('post', `clans/${clanId}/applications/${appId}/reviews`, {
          review
        },sessionKey);
      }
    },
