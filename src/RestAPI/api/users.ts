...
export default {
  ...
  moderateContent: {
    post(
      ...
      return v3('post', `users/${id}/moderate-content`, {
        uid: moderatedUserId,
        operationList
      },sessionKey);
    }
  ...
  blocks: {
    ...
    post(
      ...
      return v3('post', `users/${uid}/blocks`, {
        blockedUid,
        nickname,
        source
      },sessionKey);
    ...
    delete(
      ...
      return v3('delete', `users/${uid}/blocks`, {
        blockedUid,
        source
      },sessionKey);
    }
  ...
  cashCoins: {
    ...
    withdraws: {
      get(
        ...
        return v3('get', `users/${uid}/cash-coins/withdrawals`, {
          count,
          cursor
        },sessionKey);
      },
      post(
        ...
        return v3('post', `users/${uid}/cash-coins/withdrawals`, data,sessionKey);
      }
    },
    getSupportedRegions: (
  ...
  dailyTasks: {
    ...
    post(uid: number, recordId: number,sessionKey:string) {
      return v3('post', `users/${uid}/daily-tasks`, {
        recordId
      },sessionKey);
    }
  },
  timeLimitedEvents: {
    get(
      ...
      return v3('get', `users/${uid}/time-limited-events`, {
        type
      },sessionKey);
    },
    post(
      ...
      return v3('post', `users/${uid}/time-limited-events`, {
        recordUuid,
        rewardOpType
      },sessionKey);
    }
  ...
  dailyLogin: {
    ...
    post(uid: number, review: DLClaimRequest = DLClaimRequest.CLAIM,sessionKey:string) {
      return v3('post', `users/${uid}/daily-logins`, {
        review
      },sessionKey);
    }
  },
  deviceToken(
    ...
    return v3('post', `users/${uid}/device-tokens`, {
  ...
  followings: {
    ...
    delete(channelId: number, userId: number,sessionKey:string): Promise<void> {
      return v3('delete', `users/${userId}/followings`, {
    ...
    get(
      ...
      return v3('get', `users/${uid}/followings`, {
        cursor,
        count
      },sessionKey);
    },
    patch(
      ...
      return v3('patch', `users/${userId}/followings`, {
        followeeUid: channelId,
        notification
      },sessionKey);
    },
    post(
      ...
      return v3('post', `users/${userId}/followings`, {
        followeeUid: channelId,
        source
      },sessionKey);
    },
  ...
  receivedLikes: {
    getCount(
      ...
      return v3('get', `users/${userId}/received-likes/count`, { type },sessionKey);
    }
  },
  likedPlaybacks: {
    get(
      ...
      return v3('get', `users/${userId}/liked-playbacks`, {
        type,
        cursor,
        count
      },sessionKey);
    ...
    getCount(
      ...
      return v3('get', `users/${userId}/liked-playbacks/count`, { type },sessionKey);
    }
  },
  linkedGames: {
    ...
    delete(userId: number, gameId: number,sessionKey: string): Promise<void> {
      return v3('delete', `users/${userId}/linked-games/${gameId}`,{},sessionKey);
    },
    getItem(userId: number, gameId: number,sessionKey: string): Promise<any> {
      return v3('get', `users/${userId}/linked-games/${gameId}`,{},sessionKey);
    },
    post(userId: number, gameId: number, token: string,sessionKey: string): Promise<void> {
      return v3('post', `users/${userId}/linked-games`, { gameId, token },sessionKey);
    }
  },
  linkedPlatforms: {
    get(
      ...
      return v3('get', `users/${userId}/linked-platforms`, {
        forceRefresh: 1
      },sessionKey);
    },
    delete(userId: number, platform: string,sessionKey:string): Promise<void> {
      return v3('delete', `users/${userId}/linked-platforms/${platform}`,{},sessionKey);
    },
    patch(userId: number, platform: string, enable: boolean,sessionKey:string): Promise<void> {
      return v3('patch', `users/${userId}/linked-platforms/${platform}`, {
        enable: enable ? 1 : 0
      },sessionKey);
    },
    custom: {
      post(
        ...
        return v3('post', `users/${userId}/linked-platforms/custom`, {
          serverAddr,
          streamKey,
          name
        },sessionKey);
    ...
    disableWhileStreaming(userId: number, platformId: 0 | 1 | 2,sessionKey:string) {
      ...
      return v3('delete', `channels/${userId}/forwarders/${platformId}`,{},sessionKey);
    }
  },
  ...
  getPushMessages(
    ...
    return v3('get', `users/${userId}/push-messages`, {
      toMsgId: cursor,
      count
  ...
  pushMessageSessions: {
    ...
    patch(userId: number, readMsgId: number,sessionKey:string): Promise<{ readMsgId: number }> {
      return v3('patch', `users/${userId}/push-message-sessions`, {
        readMsgId
      },sessionKey);
    }
  },
  ...
  > {
    return v3('get', `users/${userId}/recommended-streamers`, {
      contentLanguage
    },sessionKey);
  },
  getRecommendedStream(
    ...
    return v3('get', `users/${userId}/recommended-streams`, {
  ...
  realLifePrizes: {
    get(
      ...
      return v3('get', `users/${userId}/real-life-prizes`, {
        type
      },sessionKey);
    },
    ...
    post(
      ...
      return v3('post', `users/${userId}/real-life-prizes`, {
        ...prizeUser,
        prizeId
      },sessionKey);
    }
  ...
  clipFeeds: {
    ...
    delete(userId: number, uuidList: string[],sessionKey:string): Promise<void> {
      return v3('delete', `users/${userId}/clip-feeds`, {
        uuidList
      },sessionKey);
    },
    getVerifiedClipFeeds(
      ...
      return v3('get', `users/${userId}/verified-clip-feeds`, params,sessionKey);
    }
  },
  contentTags: {
    get(
    ...
    patch(userId: number, tagUniqList: string[],sessionKey:string): Promise<void> {
      return v3('patch', `users/${userId}/content-tags`, {
        tagUniqList
      },sessionKey);
    }
  },
  gameFollowings: {
    ...
    post(uid: number, gameIdList: number[],sessionKey:string): Promise<void> {
      return v3('post', `users/${uid}/game-followings`, {
        gameIdList
      },sessionKey);
    },
    delete(uid: number, gameIdList: number[],sessionKey:string): Promise<void> {
      return v3('delete', `users/${uid}/game-followings`, {
        gameIdList
      },sessionKey);
    }
  }
