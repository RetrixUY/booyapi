...
export default {
  ...
  feedbacks: {
    post(
      ...
      return v3('post', 'reports/feedbacks', {
        uid: userUID,
        description,
        email,
        screenshotsList,
  ...
  clientEvents: {
    post(
      ...
      return v3('post', 'reports/client-events', {
        clientVersion: 'web',
        deviceId,
        events,
        language,
  ...
  embedConnects: {
    post(channelId: number, deviceId: string,sessionKey: string): Promise<void> {
      return v3('post', 'reports/embed-connects', {
        channelId,
        deviceId,
        uid: deviceId
      },sessionKey);
  ...
  embedHeartbeat: {
    post(channelId: number, deviceId: string,sessionKey: string): Promise<void> {
      return v3('post', 'reports/embed-heartbeats', {
        channelId,
        deviceId,
        uid: deviceId
      },sessionKey);
